...
switch action
    ...
    case 'init',
        ...
        set(value(myfig), 'Position', [20   50   1034   868], 'Visible', 'on');
        x = 5; y = 5;
%     gcf;
        ...
        DispParam(obj, 'currentOdorORMix', NaN, x, y, 'label', 'Current stimulus identity', 'labelfraction', 0.7); next_row(y,3);
        ...
        stimVector.value = 0;
        SubHeaderParam(obj, 'stimHeader', 'Odor stimuli parameters', x, y); next_row(y,3);
        ...
        SubHeaderParam(obj, 'odorHeader', 'Odor stimuli', x, y); next_row(y,3.1);
        ...
        PushbuttonParam(obj, 'SetStimAssignment', x, y,'label','Assign stimuli',...
            'position', [x y 200 50], 'BackgroundColor', [0.1 0.5 0.5]); next_row(y,5);
        set_callback(SetStimAssignment, {'OdorSection', 'setStimAssignment'});

        
        NumEditParam(obj, 'stim4Mix2Stim', NaN, x, y, 'label', 'Stim 4'); next_row(y,1);
        NumEditParam(obj, 'stim3Mix2Stim', NaN, x, y, 'label', 'Stim 3'); next_row(y,1);
        NumEditParam(obj, 'stim2Mix2Stim', NaN, x, y, 'label', 'Stim 2'); next_row(y,1);
        NumEditParam(obj, 'stim1Mix2Stim', NaN, x, y, 'label', 'Stim 1'); next_row(y,1);
        SubHeaderParam(obj, 'mix2StimHeader', 'Mix 2', x, y); next_row(y,4);
        NumEditParam(obj, 'stim4Mix1Stim', NaN, x, y, 'label', 'Stim 4'); next_row(y,1);
        NumEditParam(obj, 'stim3Mix1Stim', NaN, x, y, 'label', 'Stim 3'); next_row(y,1);
        NumEditParam(obj, 'stim2Mix1Stim', NaN, x, y, 'label', 'Stim 2'); next_row(y,1);
        NumEditParam(obj, 'stim1Mix1Stim', NaN, x, y, 'label', 'Stim 1'); next_row(y,1);
        SubHeaderParam(obj, 'mix1StimHeader', 'Mix 1', x, y); next_row(y,4);
        NumEditParam(obj, 'stim4Odor2Stim', NaN, x, y, 'label', 'Stim 4'); next_row(y,1);
        NumEditParam(obj, 'stim3Odor2Stim', NaN, x, y, 'label', 'Stim 3'); next_row(y,1);
        NumEditParam(obj, 'stim2Odor2Stim', NaN, x, y, 'label', 'Stim 2'); next_row(y,1);
        NumEditParam(obj, 'stim1Odor2Stim', NaN, x, y, 'label', 'Stim 1'); next_row(y,1);
        SubHeaderParam(obj, 'odor2StimHeader', 'Odor 2', x, y); next_row(y,4);
        NumEditParam(obj, 'stim4Odor1Stim', NaN, x, y, 'label', 'Stim 4'); next_row(y,1);
        NumEditParam(obj, 'stim3Odor1Stim', NaN, x, y, 'label', 'Stim 3'); next_row(y,1);
        NumEditParam(obj, 'stim2Odor1Stim', NaN, x, y, 'label', 'Stim 2'); next_row(y,1);
        NumEditParam(obj, 'stim1Odor1Stim', NaN, x, y, 'label', 'Stim 1'); next_row(y,1);
        SubHeaderParam(obj, 'odor1StimHeader', 'Odor 1', x, y); next_row(y,3);
        
        SubHeaderParam(obj, 'stimAssignmentHeader', 'Stimuli assignment', x, y); next_row(y,2);
...
%        nextStimVectorConc.value = zeros(1,1000);
       ...
       SoloParamHandle(obj, 'currentStimAll');
...
%        stimListTrialNMix1.value = nan(1, 1000);
       ...
       SoloParamHandle(obj, 'stimVectorAll');
       bankVectorMix2.value = 0;
...
%                 disp(value(valveVectorOdor2))
        ...
        case 'setStimAssignment'
            
        switch(value(taskIdentity))
            case 'Concentration task'
                stimVectorAll.value = [value(stim1Odor1Stim) value(stim2Odor1Stim) value(stim3Odor1Stim) value(stim4Odor1Stim) ...
                    value(stim1Odor2Stim) value(stim2Odor2Stim) value(stim3Odor2Stim) value(stim4Odor2Stim)];
                stimVectorAll(find(isnan(value(stimVectorAll)) == 1)) = [];
                disp(value(stimVectorAll))
            case 'Mixture task'
                stimVectorAll.value = [value(stim1Mix1Stim) value(stim2Mix1Stim) value(stim3Mix1Stim) value(stim4Mix1Stim) ...
                    value(stim1Mix2Stim) value(stim2Mix2Stim) value(stim3Mix2Stim) value(stim4Mix2Stim)];
                stimVectorAll(find(isnan(value(stimVectorAll)) == 1)) = [];
                disp(value(stimVectorAll))
            case 'Both - blocks'
                stimVectorAll.value = [value(stim1Odor1Stim) value(stim2Odor1Stim) value(stim3Odor1Stim) value(stim4Odor1Stim) ...
                    value(stim1Odor2Stim) value(stim2Odor2Stim) value(stim3Odor2Stim) value(stim4Odor2Stim) ...
                    value(stim1Mix1Stim) value(stim2Mix1Stim) value(stim3Mix1Stim) value(stim4Mix1Stim) ...
                    value(stim1Mix2Stim) value(stim2Mix2Stim) value(stim3Mix2Stim) value(stim4Mix2Stim)];
                stimVectorAll(find(isnan(value(stimVectorAll)) == 1)) = [];
                disp(value(stimVectorAll))
            case 'Both - interleaved'
...
%        elapsedTrials.value = 0;
       ...
       currentStimMix1.value = nan(1000,2);
       currentStimMix2.value = nan(1000,2);
       currentStimAll.value = nan(1000,1);
       ...
       switch(value(taskIdentity))
            case 'Concentration task'
                if value(currentOdor(1, n_started_trials + 1)) == 1
                    ...
                    currentStimAll(n_started_trials + 1) = value(stimVectorAll(find(fliplr(value(stimVector)) == value(nextStimConc))));
                elseif value(currentOdor(1, n_started_trials + 1)) == 2
                    ...
                    currentStimAll(n_started_trials + 1) = value(stimVectorAll(find(fliplr(value(stimVector)) == value(nextStimConc)) + 4));
                end
%                     disp(value(stimVector))
...
%                     disp(value(currentValve(n_started_trials + 1)))
            case 'Mixture task'
                if value(currentOdor(1, n_started_trials + 1)) == 3
                    ...
                    currentStimAll(n_started_trials + 1) = value(stimVectorAll(find(fliplr(value(stimVector)) == value(nextStimMix))));
                elseif value(currentOdor(1, n_started_trials + 1)) == 4
                    ...
                    currentStimAll(n_started_trials + 1) = value(stimVectorAll(find(fliplr(value(stimVector)) == value(nextStimMix)) + 4));
                end
                ...
                switch(value(blockTaskFirstBlock))
                    ...
                    case 'Mixture task'
                        if value(currentOdor(1, n_started_trials + 1)) == 3
                            ...
                            currentBank(n_started_trials + 1) = value(bankVectorMix1(find(fliplr(value(stimVector)) == value(nextStimMix))));
                            currentValve(n_started_trials + 1) = value(valveVectorMix1(find(fliplr(value(stimVector)) == value(nextStimMix))));
                            currentStimAll(n_started_trials + 1) = value(stimVectorAll(find(fliplr(value(stimVector)) == value(nextStimMix)) + 8));
                        elseif value(currentOdor(1, n_started_trials + 1)) == 4
                            currentStim(n_started_trials + 1, :) = [n_started_trials + 1 value(nextStimMix)];
                            currentStimMix(n_started_trials + 1, :) = [n_started_trials + 1 value(nextStimMix)];
                            currentStimMix2(n_started_trials + 1, :) = [n_started_trials + 1 value(nextStimMix)];
                            currentBank(n_started_trials + 1) = value(bankVectorMix2(find(fliplr(value(stimVector)) == value(nextStimMix))));
                            currentValve(n_started_trials + 1) = value(valveVectorMix2(find(fliplr(value(stimVector)) == value(nextStimMix))));
                            currentStimAll(n_started_trials + 1) = value(stimVectorAll(find(fliplr(value(stimVector)) == value(nextStimMix)) + 12));
                        end
                end
...
%        disp(value(currentStimAll(n_started_trials + 1)));
                    ...
                    case 'Mixture task'
                        ...
                        elseif strcmp(r, 'odd')
                            ...
                            elseif value(concListAll(1, n_started_trials + 1)) == 2
                                ...
                                currentStimConc(n_started_trials + 1, :) = [n_started_trials + 1 value(nextStimConc)];
                                currentStimOdor2(n_started_trials + 1, :) = [n_started_trials + 1 value(nextStimConc)];
                                currentStimAll(n_started_trials + 1) = value(stimVectorAll(find(fliplr(value(stimVector)) == value(nextStimConc)) + 8));
