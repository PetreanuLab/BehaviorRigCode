...
switch action
    ...
    case 'init',
        ...
        set(value(myfig), 'Position', [50   50   210   550], 'Visible', 'on');
        x = 5; y = 5;
...
%       DispParam(obj, 'olf_carrier_flow', 0, x, y, 'label', ' Carrier flow rate');   next_row(y,1);
  ...
  % Initialize odor settings
      ...
      NumeditParam(obj, 'olf_carrier_flow_set', 900, x, y, 'label','Target carr. fl.rate');  next_row(y,1);
...
%       SoloFunctionAddVars('OlfactometerSection','rw_args','olf');
      ...
      DispParam(obj, 'olf_status', 'disconnected', x, y, 'label', ' recent status'); next_row(y, 1);
...
%     case 'olf_connect',    
    ...
    SoloFunctionAddVars('Training', 'ro_args', {'olf', 'olf_bank_A_ID', 'olf_bank_B_ID'});
    SoloFunctionAddVars('StateMatrixSection', 'ro_args',{'OLF_IP',...
                        'olf_bank_A_ID', 'olf_bank_B_ID', 'olf_bank_C_ID', 'olf_bank_D_ID'});
    SoloFunctionAddVars('olfprotocol', 'ro_args',{'olf',...
                        'olf_bank_A_ID', 'olf_bank_B_ID', 'olf_bank_C_ID', 'olf_bank_D_ID'});
