...
%     disp(value(rValve))
    ...
    sma = add_scheduled_wave(sma, 'name', 'too_late_JITTER_SW', ...
        'preamble', (value(too_late_jitter)));
                        ...
                        if strcmp (value(stim1Side), 'Left') == 1
                            ...
                            if (value(currentOdor(1,n_started_trials + 1)) == 1 || ...
                                ...
                                sma= add_state(sma,'name', 'waiting_for_both_pokes_water',...
                                    ...
                                    'RWD_DELAY_INTER_TRIAL_SW_Out', 'too_late_prevention'});
                                
                                sma = add_state(sma, 'name', 'too_late_prevention', ...
                                    'output_actions', {'SchedWaveTrig', 'too_late_JITTER_SW'}, ...
                                    'input_to_statechange', {'too_late_JITTER_SW_In', 'too_late',...
                                    'Lin', 'left_poke_in_correct_water'});
...
%                                     'input_to_statechange', {'Tup', 'final_state'});
                                ...
                                % Virtual right poke in correct
                                sma = add_state(sma, 'name', 'right_poke_in_correct_water');
                                
                                % Virtual left poke in error
                                sma = add_state(sma, 'name', 'left_poke_in_error_water');
                           ...
                           elseif (value(currentOdor(1,n_started_trials + 1)) == 2 || ...
                                ...
                                sma = add_state(sma, 'name', 'too_late_prevention', ...
                                    'output_actions', {'SchedWaveTrig', 'too_late_JITTER_SW'}, ...
                                    'input_to_statechange', {'too_late_JITTER_SW_In', 'too_late',...
                                    'Rin', 'right_poke_in_correct_water'});
...
%                                     'input_to_statechange', {'Tup', 'final_state'});
                                ...
                                % Virtual left poke in correct
                                sma = add_state(sma, 'name', 'left_poke_in_correct_water');
                                
                                % Virtual right poke in error
                                sma = add_state(sma, 'name', 'right_poke_in_error_water');
