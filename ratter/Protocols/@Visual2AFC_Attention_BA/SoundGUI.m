...
switch action
    ...
    case 'init'
        ...
        set(value(sound_fig), 'Name', name, 'Tag', name, ...
            'Position', [ 634   833   215    190], 'Visible', 'off',...
        ...
        NumeditParam(obj, 'cueVolume', 2, x, y, 'TooltipString', 'Sound volume');next_row(y);
        NumeditParam(obj, 'cue1Freq', 8000,  x, y, 'TooltipString', 'Sound volume');next_row(y);
        NumeditParam(obj, 'cue2Freq', 8000,  x, y, 'TooltipString', 'Sound volume');next_row(y);
        NumeditParam(obj, 'cueSoundLength', 0.5,  x, y, 'TooltipString', 'Sound volume');next_row(y);
        ...
        DeclareGlobals(obj, 'rw_args', {'rightFrequency', 'leftFrequency','cue1Freq','cue2Freq','cueVolume','cueSoundLength',...
