...
switch action
    ...
    case 'init'
        ...
        set(value(trial_fig), 'Name', name, 'Tag', name, ...
            'Position', [1096         673         215         210], 'Visible', 'off',...
        ...
        NumeditParam(obj, 'bonusN', 5,x,y,'position', [x y 100 20]) ;
        NumeditParam(obj, 'bonusWaterFac', 3,x,y,'position', [(x+100) y 100 20], 'TooltipString', '') ;next_row(y);
        %SubheaderParam(obj, 'trialHeader', 'Trial Settings', x, y); next_row(y,1.5);
        
        DeclareGlobals(obj, 'rw_args', {'punishError','resetITI','noLick'...
            'punishEarlyLick','stopLick','treadmillStim','visualError','fixedRatio','fixedRationN','bonusN','bonusWaterFac'});
