...
switch action,
    ...
    case 'init',
        ...
        DispParam(obj, 'currSoundInvalidVolume', NaN, x, y); next_row(y);
       ...
       %% History mean section
        ...
        DeclareGlobals(obj, 'rw_args', { ...
            ...
            'currCohChg','currDirnDeltaChg','currLumFoil','currLumTarg',...
            'currDensity','currSpeed','currSize','currLifeTime',...
            'currStimDuration','currResponseWindow','currChangeStimDelay',...
            'currSoundInvalidVolume','currStimSizeDeg','currRandSeed',...
            'lastMissed','lastValid','lastCorrect','lastLoc','lastTrial',...
            'performance','validPerf','invalidPerf','missFrac','performanceLoc1','performanceLoc2',...
