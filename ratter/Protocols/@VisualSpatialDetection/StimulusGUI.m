...
switch action
    ...
    case 'init'
        ...
        NumeditParam(obj, 'foilLumProb', [1 0 0 0], x, y, 'TooltipString', ...
            'Brightness of foil dots.',  'labelfraction', 0.5);next_row(y);
        ToggleParam(obj, 'useFoilTargetLum', 1, x, y, 'OnString', 'Foil/Target', ...
            'OffString', 'UnChange/Change', 'TooltipString', 'Toggle between foil/target lum definition and changeside luminance');next_row(y);
        
        NumeditParam(obj, 'stim1Pos', [1450 540], x, y, 'TooltipString', ...
            '',  'labelfraction', 0.5);next_row(y);
        NumeditParam(obj, 'stim2Pos', [300 540], x, y, 'TooltipString', ...
            '',  'labelfraction', 0.5);next_row(y);
        NumeditParam(obj, 'stimSizeDeg', [100 70 45 40], x, y, 'TooltipString', 'Array with available stimulus size');next_row(y);
        NumeditParam(obj, 'stimSizeDegProb', [0 0 1 0], x, y, 'TooltipString', 'Array with stimulus size probabilities');next_row(y);
        ...
        SubheaderParam(obj, 'stimHeader', 'Choose Valid Location', x, y); next_row(y,1.5);
        ...
        DeclareGlobals(obj, 'rw_args', {'randomDotToggle','randSeed',...
            ...
            'useFoilTargetLum','targetLum','targetLumProb','foilLum','foilLumProb','bckgLum','stim1Pos','stim2Pos','stimSizeDeg','stimSizeDegProb',...
            'cohChg','cohChgProb','dirnDeltaChg','dirnDeltaChgProb',...
            'validLocationSelection','validTrialProb','validTrialSelection','validLocation','userThisTrialValid'...
            });
