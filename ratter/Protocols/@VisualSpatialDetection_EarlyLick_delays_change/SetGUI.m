...
switch action,
    ...
    case 'init',
        ...
        SoloParamHandle(obj,'earlyHistoryLoc1','value',[]);
        SoloParamHandle(obj,'earlyHistoryLoc2','value',[]);
        ...
        DispParam(obj, 'currCorrLoop', [NaN NaN NaN NaN], x, y); next_row(y); % stimpos that is valid (1 or 2)        
        ...
        DispParam(obj, 'earlyValidLoc2',0,x,y); next_row(y);
        DispParam(obj, 'earlyValidLoc1',0,x,y); next_row(y);
 ...
 NumeditParam(obj, 'meanSize', 20, x, y, 'TooltipString', ...
        ...
        DeclareGlobals(obj, 'rw_args', { ...
            ...
            'currChangeVolume','currStimSizeDeg','currRandSeed','currCorrLoop'...
            ...
            'earlyValidLoc1','earlyValidLoc2','validPerfLoc1','validPerfLoc2','invalidPerfLoc1','invalidPerfLoc2','fracTrialLoc1',...
            ...
            'earlyHistoryLoc1','earlyHistoryLoc2',...
            'photoStim'});
