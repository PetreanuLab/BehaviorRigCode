...
switch action
    ...
    case 'init'
        ...
        set(value(timings_fig), 'Name', name, 'Tag', name, ...
            'Position', [  1112         269        215         540], 'Visible', 'off',...
        ...
        NumeditParam(obj, 'rwdWithDelay', 0.5, x, y, 'TooltipString', 'delay after offset of stimulus before tone and reward');next_row(y);
        ToggleParam(obj, 'setRespWindow', 0, x, y, 'OnString', 'Resp Window', ...
            'OffString', 'Rest of stimulus'); next_row(y);
       ToggleParam(obj, 'setRespWindowInV', 0, x, y, 'OnString', 'Resp Window InV', ...
            'OffString', 'Rest of stimulus'); next_row(y);
       ...
       SliderParam(obj, 'stimDelay', 0, 0,10, x, y, 'TooltipString', 'Delay after CUE before Stimulus.');next_row(y);
        ...
        NumeditParam(obj, 'errorSoundLength', 3, x, y);next_row(y);  % NOTE must be less than errortime out and ITI, otherwise could go into next trial 
        NumeditParam(obj, 'errorVisualLength', 3, x, y);next_row(y);  % NOTE must be less than errortime out and ITI
        ...
        DeclareGlobals(obj, 'rw_args', {'ITIMax', 'ITIMin','ITI',...
            'errorTimeOut','outDelay','rwdWithDelay','setRespWindow','setRespWindowInV',...
