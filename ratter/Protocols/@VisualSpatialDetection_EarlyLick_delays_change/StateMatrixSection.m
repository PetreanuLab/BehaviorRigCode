...
switch action
    ...
    case 'next_trial',
        ...
        if value(punishEarlyLick)
            switch value(punishEarlyLickType) % TO DO
                ...
                case 'delay_stim_change'
                    ...
                    sma = add_state(sma, 'name', 'early_licks_stimulus_delayed1','self_timer', 0.01 ,...
                    ...
                    sma = add_state(sma, 'name', 'early_licks_stimulus_delayed2','self_timer', 0.001 ,...
        ...
        sma = add_state(sma, 'name', 'change_stimulus','self_timer', 0.05,...
        ...
        sma = add_state(sma, 'name', 'reward_state_invalid','self_timer', 0.001,...
            'output_actions', {'SchedWaveTrig','reward_delivery+stop_stim_wave'},...
            'input_to_statechange', {'Tup', 'pre_iti'});
