...
switch action,
    ...
    case 'init',
        ...
        set(value(main_fig), 'Position', [424 250 430 535]);
        ...
        DeclareGlobals(obj, 'rw_args', {'currStimSide', 'currCoher',...
            ...
            'meanTimeOut','meanBias','meanAccu','meanSize','meanChoice','meanStimSide'...
            'timingsToggle','monitorToggle','stimulusToggle','trialToggle',...
            'biasToggle','soundToggle','treadmillToggle',...
            'timeOutHistory','coherHistory',...
            'correctHistory','stimSideHistory','choiceHistory','nonRandomSide',...
            'photoStim'});
