function GoNoGoDetection_Presentation(bugMe)
% %
% % For interface with GoNoGoDetection.m (Bcontrol Protocol)
% % BA 032015 
% % BA Spatial Detection which was modified from Tiago Marques's Random Dots code
%
%% Imports
...
persistent stimulus  bCue
persistent elapsedTime lastTrigger cueTime startStimTime
...
%% Trigger received
        ...
        try
            switch counter
                ...
                case 3
                    ...
                    disp(counterName);
                    TriggerDetected();  % counter updated inside this function
                    stop(hCtr);
                    start(hCtr);
    ...
    function PresentStimulusAndCue()
        ...
        while ~bstopStimulus
            try
                ...
                % Trigger has happen While PresentStimulus is happening
    ...
    function TriggerDetected()
        ...
        elseif elapsedTime > 0.11 && elapsedTime < 0.175 % detected TTL  100ms that means punishment
            bpunish = 1;
