function StimulusPresentation_Spatial(bugMe)
% %
...
%         disp('Trigger received')
    ...
    function PrepareStimulusAndCue()
        ...
        noiseSound = audioplayer((rand(s2,audio_freq*(data.error_sound_length),1) - 0.5)*(data.sound_volume),audio_freq);
    ...
    function PresentStimulusAndCue()
        bchangedStim =0; bstartStim = 0; bstopStimulus = 0;
        ...
        stimulusOnsetTime = (cueTime +...
                         ...
                         while GetSecs() <  endStimulusTime +extraTime
                             
            if GetSecs() >  endStimulusTime
                bstopStimulus = 1;
            end
            ...
            if ~bstopStimulus &  GetSecs() >= ( stimulusOnsetTime - (1/frameRate))   % % Stimulus Onset Time
    ...
    function TriggerDetected()
        ...
        if elapsedTime < 0.15
            bpunish = 0;
        else % detected TTL in more than 200ms that means punishment
            bpunish = 1;
        end
    end
