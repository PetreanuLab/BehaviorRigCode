...
hCtr.cfgSampClkTiming(1e6,'DAQmx_Val_HWTimedSinglePoint',0,'PFI1','DAQmx_Val_Rising'); %Sample rate is a 'dummy' value
...
hCtr.start();
for i=1:numChanges
    hTrigger.writeDigitalData([0;1;0],.2,true);
    start(hTimer);
    wait(hTimer);
end
