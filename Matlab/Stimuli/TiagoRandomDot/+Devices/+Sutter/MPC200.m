classdef MPC200 < Devices.Interfaces.LinearStageControllerBasic
    ...
    methods
        function obj = MPC200(varargin)     
           ...
           %    resolution: Resolution, in um, for all dimensions (specified as scalar) or per-dimension (specified as 3 element vector).If not, default resolution associated with specified 'stageType' is used. 
            ...
            obj = obj@Devices.Interfaces.LinearStageControllerBasic(stageType,'availableBaudRates',[128000],varargin{:});   
    ...
    methods (Access=protected)
        function pdepPropHandleGetHook(obj,src,evnt)
            ...
            switch propName
                case {'positionAbsolute' 'isMoving' 'maxVelocity' 'stageAssemblyIndex' 'infoHardware'}
    ...
    %% SUBCLASS-SPECIFIC PUBLIC METHODS
    ...
    methods
        ...
        function resumeMove(obj)
            if obj.isMoveInterrupted
                obj.moveStart([1 1 1]); %send it garbage coords to restart the previous move
